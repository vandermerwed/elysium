...
import { getNodeMetrics, getGraphStats } from "./noteGraph";
...
export function computeGardenStats(
  ...
  const byTopology = { hubs: 0, relays: 0, terminals: 0 };
  let totalLinks = 0;
  ...
  graph.forEachNode((nodeId, attrs) => {
    ...
    const score = computeNexusScore(metrics);
