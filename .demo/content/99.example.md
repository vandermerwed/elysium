...
```bash
npx nuxi init -t themes/elysium my-website
```
...
The navigation is generated from your pages, you can take a look at the [`<Navbar>`](https://github.com/vandermerwed/elysium/blob/main/theme/components/Navbar.vue) component to see how it works.
...
You can configure Elysium global configuration in the `app.config.ts` file:
...
See the `<MarkdownBlock>` component in [`components/content/MarkdownBlock.vue`](https://github.com/vandermerwed/elysium/blob/main/components/content/MarkdownBlock.vue).
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%vandermerwed%2Felysium-template) [![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/vandermerwed/elysium-template)
...
You are at the end of the page, you can checkout the [about page](/about) or the [GitHub repository](https://github.com/vandermerwed/elysium) and give a :icon{name="ph:star-duotone"}

Thanks to [Atinux](https://twitter.com/Atinux) for his work on Content Wind (TODO: Insert link).
